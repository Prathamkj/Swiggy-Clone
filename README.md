...
Check out the live version of the website here: [Swiggy](https://majestic-melomakarona-cc64ca.netlify.app/)
...
1. Clone the repository: `git clone https://github.com/Prathamkj/Swiggy-Clone.git`
